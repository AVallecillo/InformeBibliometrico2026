...
SPECIAL_WATCHLIST = {
    ...
    "DIS": "Debe usar conf/ACMdis, no conf/dis; excluir Companion.",
    "FC": "Booktitle largo: Financial Cryptography and Data Security; excluir workshops.",
    "SEAMS": "Booktitle largo: Software Engineering for Adaptive and Self-Managing Systems.",
    "MICCAI": "Booktitle largo en múltiples partes; usar coincidencia parcial MICCAI y excluir workshops.",
