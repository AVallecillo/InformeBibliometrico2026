#!/usr/bin/env python3
"""
PASO 10b — OpenReview expandido/discovery controlado, con salida como evidencias.
...
Salida:
  ...
  outputs/openreview_expanded_affiliations_cache.json
  outputs/openreview_expanded_venue_audit.csv
  outputs/openreview_expanded_unresolved.csv
...
CHECKPOINT_FILE = CHECKPOINTS / "step10b_openreview_expanded.json"

CACHE_FILE = OUTPUTS / "openreview_expanded_affiliations_cache.json"
EVIDENCE_FILE = OUTPUTS / "affiliation_evidence_openreview_expanded.csv"
AUDIT_FILE = OUTPUTS / "openreview_expanded_venue_audit.csv"
UNRESOLVED_FILE = OUTPUTS / "openreview_expanded_unresolved.csv"
REPORT_FILE = OUTPUTS / "openreview_expanded_coverage_report.txt"
...
OPENREVIEW_VENUES: dict[str, list[tuple[str, int, int]]] = {
    # Mantener algunas variantes de los venues ya probados por si quedan años sin resolver.
    # El consolidador evitará duplicados con affiliation_evidence_openreview.csv.
    "AISTATS": [
        # Variantes históricas/comunitarias habituales. Se aceptan solo si hay match por título.
        ("AISTATS.cc/2021/Conference", 2021, 2),
        ...
        ("aistats.org/AISTATS/2022/Conference", 2022, 2),
        ("aistats.org/AISTATS/2023/Conference", 2023, 2),
        ("aistats.org/AISTATS/2024/Conference", 2024, 2),
        ("aistats.org/AISTATS/2025/Conference", 2025, 2),
        ("AISTATS/2022/Conference", 2022, 2),
        ("AISTATS/2023/Conference", 2023, 2),
        ("AISTATS/2024/Conference", 2024, 2),
        ("AISTATS/2025/Conference", 2025, 2),
    ],
    "UAI": [
        ...
        ("UAI.cc/2022/Conference", 2022, 2),
        ("UAI.cc/2023/Conference", 2023, 2),
        ("UAI.cc/2024/Conference", 2024, 2),
        ("UAI.cc/2025/Conference", 2025, 2),
        ("UAI/2022/Conference", 2022, 2),
        ("UAI/2023/Conference", 2023, 2),
        ("UAI/2024/Conference", 2024, 2),
        ("UAI/2025/Conference", 2025, 2),
    ],
    "ACMMM": [
        ("acmmm.org/MM/2022/Conference", 2022, 2),
        ("acmmm.org/MM/2023/Conference", 2023, 2),
        ("acmmm.org/MM/2024/Conference", 2024, 2),
        ("acmmm.org/MM/2025/Conference", 2025, 2),
        ("ACMMM.org/MM/2022/Conference", 2022, 2),
        ("ACMMM.org/MM/2023/Conference", 2023, 2),
        ("ACMMM.org/MM/2024/Conference", 2024, 2),
        ("ACMMM.org/MM/2025/Conference", 2025, 2),
        ("ACM.org/MM/2023/Conference", 2023, 2),
        ("ACM.org/MM/2024/Conference", 2024, 2),
        ("ACM.org/MM/2025/Conference", 2025, 2),
    ],
    # Nuevos candidatos: solo se aceptarán si emparejan títulos DBLP.
    "AAMAS": [
        ("AAMAS/2021/Conference", 2021, 2), ("AAMAS/2022/Conference", 2022, 2),
        ("AAMAS/2023/Conference", 2023, 2), ("AAMAS/2024/Conference", 2024, 2),
        ("AAMAS/2025/Conference", 2025, 2),
        ("ifaamas.org/AAMAS/2021/Conference", 2021, 2), ("ifaamas.org/AAMAS/2022/Conference", 2022, 2),
        ("ifaamas.org/AAMAS/2023/Conference", 2023, 2), ("ifaamas.org/AAMAS/2024/Conference", 2024, 2),
        ("ifaamas.org/AAMAS/2025/Conference", 2025, 2),
    ],
    "ICWSM": [
        ("ICWSM.org/2021/Conference", 2021, 2), ("ICWSM.org/2022/Conference", 2022, 2),
        ("ICWSM.org/2023/Conference", 2023, 2), ("ICWSM.org/2024/Conference", 2024, 2),
        ("ICWSM.org/2025/Conference", 2025, 2),
        ("AAAI.org/ICWSM/2021/Conference", 2021, 2), ("AAAI.org/ICWSM/2022/Conference", 2022, 2),
        ("AAAI.org/ICWSM/2023/Conference", 2023, 2), ("AAAI.org/ICWSM/2024/Conference", 2024, 2),
        ("AAAI.org/ICWSM/2025/Conference", 2025, 2),
    ],
    "BMVC": [
        ("BMVC/2021/Conference", 2021, 2), ("BMVC/2022/Conference", 2022, 2),
        ("BMVC/2023/Conference", 2023, 2), ("BMVC/2024/Conference", 2024, 2),
        ("BMVC/2025/Conference", 2025, 2),
        ("bmvc2021.org/Conference", 2021, 2), ("bmvc2022.org/Conference", 2022, 2),
        ("bmvc2023.org/Conference", 2023, 2), ("bmvc2024.org/Conference", 2024, 2),
        ("bmvc2025.org/Conference", 2025, 2),
    ],
    "COLT": [
        ("COLT.cc/2021/Conference", 2021, 2), ("COLT.cc/2022/Conference", 2022, 2),
        ("COLT.cc/2023/Conference", 2023, 2), ("COLT.cc/2024/Conference", 2024, 2),
        ("COLT.cc/2025/Conference", 2025, 2),
        ("learningtheory.org/COLT/2021/Conference", 2021, 2),
        ("learningtheory.org/COLT/2022/Conference", 2022, 2),
        ("learningtheory.org/COLT/2023/Conference", 2023, 2),
        ("learningtheory.org/COLT/2024/Conference", 2024, 2),
        ("learningtheory.org/COLT/2025/Conference", 2025, 2),
    ],
    "KR": [
        ("KR.org/2021/Conference", 2021, 2), ("KR.org/2022/Conference", 2022, 2),
        ("KR.org/2023/Conference", 2023, 2), ("KR.org/2024/Conference", 2024, 2),
        ("KR.org/2025/Conference", 2025, 2),
    ],
    "ECAI": [
        ("ECAI/2020/Conference", 2020, 2), ("ECAI/2022/Conference", 2022, 2),
        ("ECAI/2023/Conference", 2023, 2), ("ECAI/2024/Conference", 2024, 2),
        ("ECAI/2025/Conference", 2025, 2),
        ("ecai2023.eu/Conference", 2023, 2), ("ecai2024.eu/Conference", 2024, 2),
    ],
    "AAAI": [
        # AAAI main track no suele estar en OpenReview; se deja como discovery controlado.
        ("AAAI.org/2021/Conference", 2021, 2), ("AAAI.org/2022/Conference", 2022, 2),
        ("AAAI.org/2023/Conference", 2023, 2), ("AAAI.org/2024/Conference", 2024, 2),
        ("AAAI.org/2025/Conference", 2025, 2),
    ],
    # Sistemas/seguridad: probablemente no funcionen, pero el matching por título evita contaminación.
    "NDSS": [
        ("NDSS/2021/Conference", 2021, 2), ("NDSS/2022/Conference", 2022, 2),
        ("NDSS/2023/Conference", 2023, 2), ("NDSS/2024/Conference", 2024, 2),
        ("NDSS/2025/Conference", 2025, 2),
    ],
    "USENIX-Security": [
        ("USENIX.org/USENIXSecurity/2021/Conference", 2021, 2),
        ("USENIX.org/USENIXSecurity/2022/Conference", 2022, 2),
        ("USENIX.org/USENIXSecurity/2023/Conference", 2023, 2),
        ("USENIX.org/USENIXSecurity/2024/Conference", 2024, 2),
        ("USENIX.org/USENIXSecurity/2025/Conference", 2025, 2),
    ],
    "OSDI": [
        ("USENIX.org/OSDI/2021/Conference", 2021, 2), ("USENIX.org/OSDI/2022/Conference", 2022, 2),
        ("USENIX.org/OSDI/2023/Conference", 2023, 2), ("USENIX.org/OSDI/2024/Conference", 2024, 2),
        ("USENIX.org/OSDI/2025/Conference", 2025, 2),
    ],
    "FAST": [
        ("USENIX.org/FAST/2021/Conference", 2021, 2), ("USENIX.org/FAST/2022/Conference", 2022, 2),
        ("USENIX.org/FAST/2023/Conference", 2023, 2), ("USENIX.org/FAST/2024/Conference", 2024, 2),
        ("USENIX.org/FAST/2025/Conference", 2025, 2),
    ],
}
    ...
    for row, matched_title, sim, matched_by, author_ids in matched_items:
        ...
        for cc in sorted(countries):
            ...
            evidence_rows.append({
                ...
                "window": row["window"],
                "country_code": cc,
                "source": "openreview_expanded",
                "method": "expanded_venue_profile_title_match",
...
def build_report(papers: pd.DataFrame, target_total: int, evidence: list[dict], audits: list[dict]) -> str:
    ...
    lines = []
    lines.append("=== PASO 10b — OPENREVIEW EXPANDIDO ===\n")
...
def run(username=None, password=None, force=False, limit_venues: int | None = None, limit_papers: int | None = None):
    ...
    print("\n  ✅ Paso 10 completado → outputs/affiliation_evidence_openreview_expanded.csv")
