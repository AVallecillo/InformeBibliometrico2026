...
BOOKTITLE_PREFIXES = {
    ...
    "FC":        {"Financial Cryptography", "Financial Cryptography and Data Security"},
    "SEAMS":     {"SEAMS", "Software Engineering for Adaptive and Self-Managing Systems"},
    "DIS":       {"Designing Interactive Systems", "ACM Designing Interactive Systems"},
    "SIGGRAPH":  {"SIGGRAPH"},
...
ACCEPTED_BOOKTITLES = {
    ...
    "ESORICS":    {"ESORICS"},
    "ASIACRYPT":  {"ASIACRYPT"},
    "FC":         {"FC", "Financial Cryptography", "Financial Cryptography and Data Security"},
    "RAID":       {"RAID"},
    "ACSAC":      {"ACSAC"},
    "AsiaCCS":    {"AsiaCCS"},
    "PETS":       {"PETS", "PoPETs", "Proceedings on Privacy Enhancing Technologies", "Proc. Priv. Enhancing Technol.", "Proc. Priv. Enhancing Technol"},
    "CHES":       {"CHES"},
    "EuroS&P":    {"EuroS&P"},
    "CSF":        {"CSF"},
    "SOUPS":      {"SOUPS"},
    ...
    "SiggraphA":  {"SIGGRAPH Asia"},
    "CSCW":       {"CSCW"},
    "DIS":        {"DIS", "Designing Interactive Systems", "ACM Designing Interactive Systems"},
    "IUI":        {"IUI"},
    "ASSETS":     {"ASSETS"},
    "UMAP":       {"UMAP"},
    "SIGCSE":     {"SIGCSE"},
